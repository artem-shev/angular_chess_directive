(function() {
	...
	MainController.$inject = ['figureService', 'boardService', 'userService'];
	
	function MainController(figureService, boardService, userService) {
		var vm = this;
